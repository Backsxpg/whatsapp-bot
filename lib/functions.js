...
const fb = async (url) => {
    ...
    return {
        'capt': '[ ERROR ] Não encontrado!', 'exts': '.jpg', 'url': 'https://c4.wallpaperflare.com/wallpaper/976/117/318/anime-girls-404-not-found-glowing-eyes-girls-frontline-wallpaper-preview.jpg'
    }
}
...
const jadwalTv = async (query) => {
    ...
    switch(query) {
        ...
        case 'transtv':
            ...
            break
        default:
            return '[ ERROR ] Canal de TV errado! por favor, verifique a lista de canais digitando o comando *!listChannel*'
            break
    }
}
